...
function Application_detail_extention() {
  return (
    <div>
    <div className="">
  ...
  <div className="w-[81rem] h-full bg-gradient-to-br m-10 from-gray-200 to-gray-100 pt-5 pr-8 pl-8">
    ...
    <div className="flex flex-col gap-2 mt-2">
      ...
      <span>
        <span className="font-bold">Existing commitments :</span> {data.isMatch?.existing_commitments}.
      </span>
      <span>
        <span className="font-bold">Team size :</span> {data.isMatch?.team_size}.
      </span>
      <span>
...
export default Application_detail_extention