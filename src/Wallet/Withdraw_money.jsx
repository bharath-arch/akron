    ...
    <div className="  w-96 h-96 border-2 p-3 bg-white">
        <div className="relative mb-3">
            <span className="absolute left-[20.75rem]">
                <IoCloseOutline size={23} onClick={withdrawclosetogglebutton}  className="hover:bg-red-600 cursor-pointer"/>
            </span>
        </div>
      ...
      <div className="mt-2 flex justify-center w-full">
        ...
        <div className="relative">
            <button className="absolute top-[5.75rem] left-[16rem] border bg-red-600 hover:bg-red-700 text-white px-8 py-1 font-arima rounded-lg ">
                pay
            </button>
        </div>
      </div>
